<template>
    <div>
        <div class="outside-the-window" @click="closeWindow()">
            <div class="window animated fadeInDown">
                <h1>{{ hoverCloseColor }}</h1>
                ...
                <div class="window-content">
                    ...
                    <span>
                        <!--Текст ошибки-->
                        Не соответствует формат загружаемых фото. Рекомендуемые форматы - BMP; GIF; JPG; PNG; TIFF
                    </span>
                    <span class="d-block">Не удается загрузить фото:</span>
                    <span class="error-file d-block">
                        <!--Название ошибочного файла(v-for)-->
                        Фото 1.docx
                    </span>

                    <div class="window-buttons d-flex">
                        <button class="window-btn-ok">Продолжить</button>
                        <button class="window-btn-cancel">Отменить</button>
                    </div>
                </div>
            </div>
        </div>
